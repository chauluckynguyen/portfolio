...
const Project1 = () => (
  <div>
    <Navigation/>
      <Section headerClass="ln-section__title--project" className="ln-section__project">
        ...
        <div className="ln-section__body">
          <h2 className="ln-section__title">TL;DR</h2>
          <p className="ln-section__summary">
            ServiceNow — much like many large, corporate enterprises, faced its own battles with fostering a design-first mentality into its work culture. 
          ...
          <h2 className="ln-section__title">What is the Design System?</h2>
          <p className="ln-section__summary">
            ...
            can focus on executing business goals and achieving product vision. The Design System aims to bring cohesion and familiarity across all ServiceNow products, 
            thus improving the user experience for both teams and individuals.
          </p>
          <h2 className="ln-section__title">The Challenge</h2>
          <p className="ln-section__summary">
            ...
            I was able to heavily lead and contribute to the project. Prior to my joining, designers had attempted ways to establish a design-first mentality into 
            ...
            between designers and engineers/product managers, this caused many of ServiceNow products to be disjointed and complex. Without the knowledge of what 
          ...
          <h2 className="ln-section__title">My Approach</h2>
          <p className="ln-section__summary">
          ...
          <h2 className="ln-section__title">The Solution</h2>
          <p className="ln-section__summary">
          ...
          <h2 className="ln-section__title">Thoughts</h2>
          <p className="ln-section__summary">
